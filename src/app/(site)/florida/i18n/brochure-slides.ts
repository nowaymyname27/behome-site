...
export type BrochureSlide = {
  /** Path under /public (e.g., /images/brochure/plane.jpg) */
  src: string;
  title: string;
  caption: string;
  body: string;
...
export const slides: Record<"en" | "es", BrochureSlide[]> = {
  en: [
    ...
    {
      src: "/images/brochure/industry.jpg",
    ...
    {
      src: "/images/brochure/biomedicine.jpg",
