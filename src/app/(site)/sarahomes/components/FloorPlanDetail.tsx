...
export default function FloorPlanDetail({
  ...
  return (
    ...
    >
      <div className="grid min-h-[38rem] grid-cols-1 md:min-h-[42rem] xl:min-h-[96vh] xl:grid-cols-[57%_43%]">
        <motion.div
        ...
        >
          <Image
            ...
            alt={imageAlt}
            fill
            className="object-contain object-center transition-transform duration-700 ease-out group-hover:scale-[1.01] xl:object-left"
        ...
        <motion.div
          ...
          viewport={{ once: false, amount: 0.25 }}
          className="order-1 flex flex-col justify-between px-6 py-9 sm:px-10 sm:py-11 lg:px-12 lg:py-14 xl:order-2 xl:py-24"
        >
          <motion.div
            initial={{ opacity: 0 }}
          ...
          <motion.div
            ...
            viewport={{ once: false, amount: 0.3 }}
            className="mt-6 max-w-xl border-y border-black/20 xl:mt-0"
          >
