...
const COPY = {
  en: {
    ...
    imageAlt: {
      ...
      floorPlan: "Everglades floor plan layout",
    },
    aria: {
      carousel: "Everglades residence carousel",
    ...
    stats: [
      ...
      },
      {
        value: "2,617 ft2",
        label: "Under Roof",
        detail: "open floor plan for active lifestyle and entertaining",
      },
      {
        value: "10,000 ft2",
        label: "Private Lots",
  ...
  es: {
    ...
    imageAlt: {
      ...
      floorPlan: "Distribucion de plano Everglades",
    },
    aria: {
      carousel: "Carrusel de la residencia Everglades",
...
export default function EvergladesCarousel() {
          ...
          >
            ...
            {activeIndex === 1 && (
              <section className={`w-full ${SLIDE_FRAME_CLASS}`}>
                <div className={`grid grid-cols-1 xl:grid-cols-[31%_69%] ${SLIDE_FRAME_CLASS}`}>
