// File: src/app/(site)/north-carolina/kallamdale/components/WhyUs.tsx
"use client";
...
type Slide = {
  src: string;
  title: string;
  caption: string; // short label shown on the tile
  body: string; // full text shown in the overlay
};

const slides: Slide[] = [
  {
    src: "/north-carolina/kallamdale/why-us/light.jpg",
  ...
  {
    src: "/north-carolina/kallamdale/why-us/materials.jpg",
  ...
  {
    src: "/north-carolina/kallamdale/why-us/storage.jpg",
    title: "Smart storage",
  ...
  {
    src: "/north-carolina/kallamdale/why-us/interior.png",
  ...
  {
    src: "/north-carolina/kallamdale/why-us/lock.jpg",
  ...
  {
    src: "/north-carolina/kallamdale/why-us/community.jpg",
  ...
  return (
    <section className="w-full bg-chrome text-chrome-foreground section-pad">
      <div className="px-6 lg:px-8 grid md:grid-cols-3 gap-8 items-start">
        ...
        {/* Right: panels with overlay chevrons */}
